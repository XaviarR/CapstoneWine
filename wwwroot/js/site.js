...
const getAccessToken = async () => {
    const clientId =
        "AQJ-nomYmdcrcJJa_kZYrA-Lzy1AdtFLCMYgwwyBhOxumCXDaQ4r7VtkGAcyDMqZhfVvz27iS7mmbgXW";
    const appSecret =
        "EO4HSd_KlqhnSw4jsegJW0WjnrDnBdoeAkjidmycQgnGSwnKXUpvQNDNRHyHuB_GeapTShssJ7UxfQqO";
